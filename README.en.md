...
- 🛠️ **Tool-calling agent** — the local Ollama provider and OpenAI/Anthropic
  API-key profiles (on their default endpoints) can read files, run
  ...
  full breakdown, including what is sent to a cloud provider
